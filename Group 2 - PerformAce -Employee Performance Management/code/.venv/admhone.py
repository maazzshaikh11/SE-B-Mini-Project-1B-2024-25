...
def open_user_dashboard(orgname="xyz", username="john"):
    ...
    def go_back():
        root.destroy()
        import homepage
        homepage.open_homepage(username)  # Pass the username to the homepage
    ...
    org_connect_label = tk.Label(sub_header_frame, text="ORGANIZATION CONNECT", font=("Arial", 12, "bold"), bg="#A4D07B")
    ...
    notification_text = tk.Text(notifications_frame, bg="#445566", fg="white", font=("Arial", 10), height=8, wrap="word")
